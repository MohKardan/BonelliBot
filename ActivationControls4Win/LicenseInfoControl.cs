                            ...
                            if (_value != null)
                            {
                                switch (_showAttr.DataFormatType)
                                {
                                    case ShowInLicenseInfoAttribute.FormatType.String:
                                        if ("False".Equals(_value.ToString()))
                                            _formatedValue = "غیرفعال";
                                        else if("True".Equals(_value.ToString()))
                                            _formatedValue = "فعال";
                                        else
                                    ...
                                    case ShowInLicenseInfoAttribute.FormatType.Date:
                                        ...
                                        {
                                            _formatedValue = ((DateTime)_value).ToShamsi().ToString();
                                        }
                                        else
                                        {
                                            _formatedValue = _value.ToString();
                                    ...
                                    case ShowInLicenseInfoAttribute.FormatType.DateTime:
                                        ...
                                        {
                                            if (_value.GetType().Equals(typeof(DateTime)))
                                            {
                                                _formatedValue = ((DateTime)_value).ToShamsi();
                                            }
                                            else
                                            {
                                                //_formatedValue = _value.ToString();
                                    ...
                                    case ShowInLicenseInfoAttribute.FormatType.EnumDescription:
                                        ...
                                        if (_name != null)
                                        {
                                            ...
                                            if (_dna != null)
                                                if("Volume".Equals(_dna.Description))
                                                {
                                                    _formatedValue = "بدون محدودیت کاربر";
                                                }
                                                else if (_dna.ToString() == "Single")
                                                {
                                                    _formatedValue = "تک کاربره";
                                                }
                                                else
                                                {
