        ...
        {
            {
                ...
                new AndroidDevice
                {
                    AndroidBoardName = "mt6735",
                    AndroidBootloader = "MAKOZ10f",
                    DeviceBrand = "LGE",
                    DeviceModel = "LG-K220",
                    DeviceModelBoot = "qcom",
                    DeviceModelIdentifier = "cm_K220",
                    FirmwareBrand = "cm_K220",
                    FirmwareFingerprint = "lge/mk6p_global_com/mk6p:6.0.1/MXB48T/1904315114CD4:user/release-keys",
                    FirmwareTags = "release-keys",
                    FirmwareType = "user",
                    HardwareManufacturer = "LGE",
                    HardwareModel = "LG-K220",
