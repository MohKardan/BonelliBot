    ...
    internal class InstaApiVersionList
    {
        ...
        public Dictionary<InstaApiVersionType, InstaApiVersion> ApiVersions()
        {
            return new Dictionary<InstaApiVersionType, InstaApiVersion>
            {
                ...
                {
                    InstaApiVersionType.Version109,
                    new InstaApiVersion
                    {
                         AppApiVersionCode = "170693940",
                         AppVersion = "109.0.0.18.124",
                         Capabilities = "3brTvw==",
                         SignatureKey = "153cab3b94f8e6a1c0711202b5f1c7064e4718cad09a3004d5e57ef3d919012a"
                    }
                }
            };
        }
