...
namespace QLicense
{
    ...
    public abstract class LicenseEntity
    {
        ...
        [Browsable(false)]
        [XmlElement("Type")]
        [ShowInLicenseInfo(true, "نوع لایسنس", ShowInLicenseInfoAttribute.FormatType.EnumDescription)]
        public LicenseTypes Type { get; set; }

        [Browsable(false)]
        [XmlElement("CreateDateTime")]
        [ShowInLicenseInfo(true, "تاریخ ایجاد", ShowInLicenseInfoAttribute.FormatType.DateTime)]
